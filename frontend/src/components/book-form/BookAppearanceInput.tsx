...
export default function BookAppearanceInput({
    formData,
    setFormData,
}: BookAppearanceInputProps) {
    const { t } = useTranslation();
    return (
        <div className="space-y-4">
            <h3 className="text-sm font-semibold text-walnut/80 uppercase tracking-wider">
                {t("book_form.appearance.title_section")}
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="medium">
                            {t("book_form.appearance.height_medium")}
                        </option>
                        <option value="tall">
                            {t("book_form.appearance.height_tall")}
                        </option>
                    </select>
                </div>
                ...
                <div>
                    <label className="block text-sm font-medium text-walnut mb-1.5">
                        {t("book_form.appearance.thickness")}
                    </label>
                    <select
                    ...
                    >
                        ...
                        <option value="regular">
                            {t("book_form.appearance.thickness_regular")}
                        </option>
                        <option value="thick">
                            {t("book_form.appearance.thickness_thick")}
                        </option>
                    </select>
                </div>
                    ...
                    <div className="space-y-3">
                            ...
                            {colorPalettes.map((palette) => (
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-lg border-2 transition-all ${
                                        formData.color1 === palette.colors[0] &&
                                        formData.color2 === palette.colors[1] &&
                                        formData.color3 === palette.colors[2]
                                ...
                                >
                                    ...
                                    <span className="text-xs text-walnut/70 ml-1">
                                        {palette.name}
                                    </span>
                                </button>
                            ))}
                        ...
                        <div className="flex items-center gap-2 p-3 bg-cream rounded-xl border border-walnut/20">
                            <span className="text-sm text-walnut/60">
                                {t("book_form.appearance.current")}
                            </span>
                            <div className="flex gap-1">
                                <input
                                    type="color"
                                    ...
                                    title={t(
                                        "book_form.appearance.color_light",
                                    )}
                                />
                                <input
                                    type="color"
                                    ...
                                    className="w-8 h-8 p-0 border-0 rounded-lg shadow-sm cursor-pointer hover:scale-110 transition-transform"
                                    title={t(
                                        "book_form.appearance.color_medium",
                                    )}
                                />
                                <input
                                    type="color"
