                ...
                {events.map((event, index) => (
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                borderColor: `rgba(122, 92, 66, ${compact ? "0.1" : "0.15"})`,
                            }}
                        >
                            <div className="flex items-start justify-between mb-2">
                                <div>
                                    <div className="font-semibold text-darkBrown capitalize">
                                        {event.type}
                                    </div>
                            ...
                            {event.metadata && (
                                <div className="mt-3 pt-3 border-t border-walnut/10">
                                    ...
                                    {event.metadata.pagesRead && (
                                        <div className="text-sm text-walnut/70">
                                            Pages:{" "}
                                            {event.metadata.pagesRead.from} →{" "}
                                            {event.metadata.pagesRead.to}
                                        </div>
                                    )}
