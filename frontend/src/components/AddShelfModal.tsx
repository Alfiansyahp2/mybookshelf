                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-walnut/60">
                                            Create a new shelf for your books
                                        </p>
                                    </div>
                                </div>
                                <button
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="20"
                                            />
                                            <p className="text-xs text-walnut/50 mt-1">
                                                Maximum number of books this
                                                shelf can hold
                                            </p>
                                        </div>
                                        ...
                                        <div className="p-4 bg-cream rounded-xl border border-walnut/20">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="text-xs font-medium text-walnut/60 uppercase tracking-wider">
                                                    Preview
                                                </span>
                                                <span className="text-xs text-walnut/50">
                                                    Capacity:{" "}
                                                    {formData.capacity} books
                                                </span>
                                            </div>
                                            <div
