      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 32, minWidth: 0 }}>
        ...
        <motion.div {...fadeUp(0.6)}>
          ...
          <Card style={{ padding: '16px 20px', border: '1px solid rgba(139,99,56,0.15)' }}>
            ...
            <div style={{ borderTop: '1px solid rgba(139,99,56,0.1)', paddingTop: 16 }}>
              <div 
              ...
              >
                ...
                <span style={{ 
                  ...
                  transform: isTimelineVisible ? 'rotate(180deg)' : 'rotate(0deg)' 
                }}>
                  ▼
                </span>
              </div>
                        ...
                        Object.entries(groupedByMonth).map(([month, monthBooks]: any) => {
                          ...
                          return (
                            <div key={month} style={{ position: 'relative', marginBottom: 24 }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginLeft: -44, marginBottom: 16 }}>
                                <span style={{ fontSize: 11, fontWeight: 700, color: BRAND.darkBrown, background: 'white', padding: '4px 8px', minWidth: 70 }}>{month} {selectedYear}</span>
                              ...
                              <div style={{ position: 'relative' }}>
                                 {/* Timeline Icon */}
                                 <div style={{ position: 'absolute', left: -53, top: 0, width: 32, height: 32, borderRadius: '50%', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 2 }}>
