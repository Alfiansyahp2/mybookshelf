...
export default function DashboardAuthorsSection({
    stats,
}: DashboardAuthorsSectionProps) {
                            ...
                            >
                                <ResponsiveContainer width="100%" height="100%">
                                    ...
                                    >
                                        ...
                                        <Bar
                                            dataKey="count"
                                            name={t("dashboard.authors.books")}
                                            fill={"#8b5cf6"}
                                            radius={[0, 4, 4, 0]}
                                            barSize={14}
                                        />
