        ...
        try {
            if (activeSessionId) {
                await endSessionMutation.mutateAsync({
                    ...
                    data: {
                        end_page: endPage,
                        notes: notes || `Durasi: ${fmt(sessionDuration)}`,
                    },
                });
                                ...
                                {[
                                    {
                                        ...
                                        label: t(
                                            "bookDetail.session.total_sessions",
                                            "Total Sesi",
                                        ),
                                        val: stats.total_sessions,
                                        sub: t(
                                            "bookDetail.session.sessions_finished",
                                            "{{count}} selesai",
                                    ...
                                    },
                                    {
                                        ...
                                        sub: t(
                                            "bookDetail.session.reading_time",
                                            "waktu membaca",
                                        ),
                                        mono: true,
                                    },
                                    {
                                        ...
                                        label: t(
                                            "bookDetail.session.total_pages_read",
                                            "Total Halaman",
                                        ),
                                        val: stats.total_pages_read,
                                        sub: t(
                                            "bookDetail.session.pages_read",
                                            "halaman dibaca",
                                        ),
                                    },
                                    {
                                        ...
                                        sub: t(
                                            "bookDetail.session.avg_speed_unit",
                                            "hlm/jam rata-rata",
                                        ),
                                    },
                                ].map((s, i) => (
