...
} from "../../hooks/accounting/useExpenseCategories";
...
export default function CategoryManager({
    ...
    const handleDelete = async (categoryId: string) => {
        if (
            window.confirm(
                t(
                    "accounting.category_manager.confirm_delete",
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-beige">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-darkBrown">
                                    {t(
                                        "accounting.category_manager.title",
                                        "Expense Categories",
                                    )}
                                </h2>
                                <p className="text-sm text-walnut/80">
                                    {t(
                                        "accounting.category_manager.subtitle",
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                {t(
                                    "accounting.category_manager.new_category",
                                    "New Category",
                                )}
                            </button>
                            <button
                        ...
                        {isLoading ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-walnut/80 mb-4">
                                    {t(
                                        "accounting.category_manager.no_categories",
                                        "No categories yet",
                                    )}
                                </p>
                                <button
                                ...
                                >
                                    {t(
                                        "accounting.category_manager.create_first",
            ...
            <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        {category.is_default && (
                            <span className="text-xs text-walnut/80">
                                {t(
                                    "accounting.category_manager.default",
                                    "Default",
                                )}
                            </span>
                        )}
            ...
            {category.monthly_budget && (
                <div className="flex items-center justify-between text-sm">
                    <span className="text-walnut/80">
                        {t(
                            "accounting.category_manager.monthly_budget",
                            "Monthly Budget",
                        )}
                    </span>
            ...
            {category.total_expenses !== undefined && (
                <div className="mt-3 pt-3 border-t border-beige">
                    <div className="flex items-center justify-between text-sm mb-2">
                        <span className="text-walnut/80">
                            {t(
                                "accounting.category_manager.total_spent",
                                "Total Spent",
                            )}
                        </span>
                        <span className="font-semibold text-darkBrown">
                        ...
                        <div className="w-full bg-beige rounded-full h-2">
                            <div
                                className={`h-2 rounded-full ${
                                    (category.budget_usage_percentage || 0) > 80
                                        ? "bg-red-500"
                                        : "bg-green-500"
                                }`}
                                style={{
                                    width: `${Math.min(category.budget_usage_percentage || 0, 100)}%`,
                                }}
                            />
                        </div>
                    )}
                ...
                >
                    <div className="p-6 border-b border-beige">
                        <h3 className="text-lg font-semibold text-darkBrown">
                            {isEditing
                                ? t(
                                      "accounting.category_manager.edit_category",
                                      "Edit Category",
                                  )
                                : t(
                                      "accounting.category_manager.new_category",
                    ...
                    <form onSubmit={onSubmit} className="p-6 space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-darkBrown mb-2">
                                {t(
                                    "accounting.category_manager.name",
                                    "Name *",
                                )}
                            </label>
                            <input
                                ...
                                placeholder={t(
                                    "accounting.category_manager.name_placeholder",
                                    "e.g., Books, Shipping",
                                )}
                            />
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-darkBrown mb-2">
                                {t(
                                    "accounting.category_manager.description",
                                    "Description",
                                )}
                            </label>
                            <textarea
                                ...
                                className="w-full px-4 py-2 bg-white border border-beige rounded-lg focus:ring-2 focus:ring-walnut focus:outline-none"
                                placeholder={t(
                                    "accounting.category_manager.desc_placeholder",
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-darkBrown mb-2">
                                    {t(
                                        "accounting.category_manager.icon",
                                        "Icon",
                                    )}
                                </label>
                                <select
                            ...
                            <div>
                                <label className="block text-sm font-medium text-darkBrown mb-2">
                                    {t(
                                        "accounting.category_manager.color",
                                        "Color",
                                    )}
                                </label>
                                <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4">
                            ...
                            >
                                {t(
                                    "accounting.category_manager.cancel",
                                    "Cancel",
                                )}
                            </button>
                            <button
                            ...
                            >
                                {isEditing
                                    ? t(
                                          "accounting.category_manager.update",
                                          "Update",
                                      )
                                    : t(
                                          "accounting.category_manager.create",
                                          "Create",
                                      )}
                            </button>
                        </div>
