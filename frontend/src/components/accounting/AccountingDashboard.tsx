    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-bold font-serif text-darkBrown tracking-wide">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {onCreateExpense && (
                        ...
                        >
                            ...
                            {t(
                                "accounting.dashboard.add_expense",
                                "Add Expense",
                            )}
                        </button>
                    )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                <motion.div
                    ...
                    style={{
                        ...
                        padding: "16px 14px",
                        boxShadow: "0 2px 12px -4px rgba(122,92,66,0.06)",
                    }}
                >
                    <div
                        style={{
                    ...
                    >
                        ...
                        >
                            {t(
                                "accounting.dashboard.total_expenses",
                                "Total Expenses",
                            )}
                        </span>
                    </div>
                    ...
                    <div style={{ fontSize: 10, color: "rgba(122,92,66,0.5)" }}>
                        {summary?.period_type === "month"
                            ? t("accounting.dashboard.this_month", "This month")
                            : t(
                                  "accounting.dashboard.selected_period",
                                  "Selected period",
                              )}
                    </div>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            {t("accounting.dashboard.pending", "Pending")}
                        </span>
                    </div>
                    <div
                        style={{
                    ...
                    <div style={{ fontSize: 10, color: "rgba(122,92,66,0.5)" }}>
                        {t(
                            "accounting.dashboard.unpaid_expenses",
                            "Unpaid expenses",
                        )}
                    </div>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            {t(
                                "accounting.dashboard.vs_last_month",
                                "vs Last Month",
                            )}
                        </span>
                    </div>
                    ...
                    <div style={{ fontSize: 10, color: "rgba(122,92,66,0.5)" }}>
                        {t("accounting.dashboard.change", "Change")}
                    </div>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            {t(
                                "accounting.dashboard.budget_status",
                                "Budget Status",
                            )}
                        </span>
                    </div>
                    ...
                    >
                        ...
                        {budgetData?.active_budgets_count || 0}
                    </div>
                    <div style={{ fontSize: 10, color: "rgba(122,92,66,0.5)" }}>
                        {t(
                            "accounting.dashboard.healthy_budgets",
                            "Healthy budgets",
                        )}
                    </div>
                </motion.div>
            ...
            {/* Budget Alerts */}
            {budgetData &&
            (budgetData.exceeded_count > 0 || budgetData.warning_count > 0) ? (
                <motion.div
                    ...
                    style={{
                        ...
                        padding: "16px",
                        boxShadow: "0 2px 12px -4px rgba(239, 68, 68, 0.1)",
                    }}
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            {t(
                                "accounting.dashboard.budget_alerts_active",
                        ...
                        >
                            {t(
                                "accounting.dashboard.budget_alerts_desc",
                                "{{exceeded}} exceeded, {{warning}} at warning level",
                                {
                                    exceeded: budgetData.exceeded_count,
                                    warning: budgetData.warning_count,
                                },
                            )}
                        </p>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                    <div
                        style={{
                            padding: "20px 24px",
                            borderBottom: "1px solid rgba(139,99,56,0.1)",
                        }}
                    >
                        <h3
                            style={{
                        ...
                        >
                            ...
                            {t(
                                "accounting.dashboard.expenses_by_category",
                                "Expenses by Category",
                            )}
                        </h3>
                    </div>
                    <div className="p-6">
                        {categoriesData.length === 0 ? (
                            <p className="text-center text-walnut/80 py-8">
                                {t(
                                    "accounting.dashboard.no_expense_data",
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            {t(
                                "accounting.dashboard.recent_expenses",
                                "Recent Expenses",
                            )}
                        </h3>
                    </div>
                    <div className="p-6">
                        {recentExpenses.length === 0 ? (
                            <p className="text-center text-walnut/80 py-8">
                                {t(
                                    "accounting.dashboard.no_recent_expenses",
                                    "No recent expenses",
                                )}
                            </p>
                        ) : (
                                    ...
                                    .map((expense: any) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                background: "#F8F5F0",
                                                borderRadius: 12,
                                                border: "1px solid rgba(139,99,56,0.05)",
                                            }}
                                        >
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        {t(
                            "accounting.dashboard.budget_overview",
                            "Budget Overview",
                        )}
                    </h3>
                </div>
                <div className="p-6">
                    <div className="grid grid-cols-3 gap-2 sm:gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-walnut leading-relaxed">
                                {t("accounting.dashboard.on_track", "On Track")}
                            </p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-walnut leading-relaxed">
                                {t("accounting.dashboard.warning", "Warning")}
                            </p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-walnut leading-relaxed">
                                {t("accounting.dashboard.exceeded", "Exceeded")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 pt-6 border-t dark:border-gray-700">
                        <div className="flex items-center justify-between text-sm mb-2">
                            <span className="text-walnut leading-relaxed">
                                {t(
                                    "accounting.dashboard.total_budget_allocation",
                        ...
                        <div className="flex items-center justify-between text-sm mb-2">
                            <span className="text-walnut leading-relaxed">
                                {t(
                                    "accounting.dashboard.total_spent",
                                    "Total Spent",
                                )}
                            </span>
                            <span className="font-semibold text-darkBrown">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <span className="text-walnut leading-relaxed">
                                {t(
                                    "accounting.dashboard.overall_usage",
                                    "Overall Usage",
                                )}
                            </span>
                            <span
                                className={`font-semibold leading-relaxed ${
                                    (budgetData?.overall_usage_percentage ||
                                        0) > 80
                                        ? "text-red-600"
                                        : "text-green-600"
                                }`}
                            >
                                {budgetData?.overall_usage_percentage?.toFixed(
                                    1,
                                )}
                                %
                            </span>
        ...
        <div className="space-y-3">
            <div className="flex items-center justify-between text-sm leading-relaxed">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-darkBrown leading-relaxed">
                ...
                <div className="text-right">
                    ...
                    <p className="text-xs text-walnut/70 leading-relaxed">
                        ...
                        {t("accounting.dashboard.expenses_count", "expenses")}
                    </p>
                </div>
            </div>
