...
import {
    ...
    useCreateBudget,
    useUpdateBudget,
} from "../../hooks/accounting/useBudgets";
...
export default function BudgetTracker({
    ...
    const budgets = Array.isArray(budgetsResponse?.data?.data)
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-walnut/80">
                                {t(
                                    "accounting.budget_tracker.total_budget",
                                    "Total Budget",
                                )}
                            </p>
                ...
                <div className="bg-cream border border-beige rounded-lg shadow-sm p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-walnut/80">
                                {t(
                                    "accounting.budget_tracker.total_spent",
                                    "Total Spent",
                                )}
                            </p>
                            <p className="text-2xl font-bold font-serif text-darkBrown">
                ...
                <div className="bg-cream border border-beige rounded-lg shadow-sm p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-walnut/80">
                                {t(
                                    "accounting.budget_tracker.remaining",
                                    "Remaining",
                                )}
                            </p>
                            <p className="text-2xl font-bold font-serif text-darkBrown">
                ...
                <div className="bg-cream border border-beige rounded-lg shadow-sm p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-walnut/80">
                                {t("accounting.budget_tracker.usage", "Usage")}
                            </p>
                            <p className="text-2xl font-bold font-serif text-darkBrown">
                                {summary?.overall_usage_percentage?.toFixed(
                                    1,
                                ) || 0}
                                %
                            </p>
                        ...
                        >
                            <span
                                className={
                                    (summary?.overall_usage_percentage || 0) >
                                    80
                                        ? "text-red-600"
                                        : "text-green-600"
                                }
            ...
            <div className="bg-cream border border-beige rounded-lg shadow-sm">
                <div className="p-6 border-b dark:border-gray-700 flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-darkBrown">
                        {t(
                            "accounting.budget_tracker.active_budgets",
                            "Active Budgets",
                        )}
                    </h3>
                    <button
                    ...
                    >
                        ...
                        {t(
                            "accounting.budget_tracker.add_budget",
                            "Add Budget",
                        )}
                    </button>
                </div>
                ...
                <div className="p-6">
                    {budgets.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-walnut/80 mb-4">
                                {t(
                                    "accounting.budget_tracker.no_budgets",
                            ...
                            >
                                {t(
                                    "accounting.budget_tracker.create_first",
            ...
            summary?.data?.warning_count > 0 ? (
                <div className="bg-cream border border-beige rounded-lg shadow-sm p-6">
                    <h4 className="text-lg font-semibold text-darkBrown mb-4">
                        {t(
                            "accounting.budget_tracker.budget_alerts",
                            "Budget Alerts",
                        )}
                    </h4>
                            ...
                            >
                                ...
                                <div>
                                    <p className="font-medium text-red-900 dark:text-red-100">
                                        {t(
                                            "accounting.budget_tracker.budgets_exceeded",
                                    ...
                                    <p className="text-sm text-red-700 dark:text-red-300">
                                        {t(
                                            "accounting.budget_tracker.exceeded_desc",
                            ...
                            >
                                ...
                                <div>
                                    <p className="font-medium text-yellow-900 dark:text-yellow-100">
                                        {t(
                                            "accounting.budget_tracker.budgets_warning",
                                            "{{count}} Budget(s) at Warning Level",
                                            {
                                                count: summary.data
                                                    .warning_count,
                                            },
                                    ...
                                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                                        {t(
                                            "accounting.budget_tracker.warning_desc",
            ...
            <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        <div
                            className={`p-2 rounded-lg ${getBudgetStatusColor(budget.status || "healthy")}`}
                        >
                        ...
                        <div>
                            ...
                            <p className="text-sm text-walnut/80 capitalize">
                                {budget.period}
                            </p>
                        </div>
                    </div>
            ...
            <div className="mb-3">
                <div className="flex justify-between text-sm mb-1">
                    <span className="text-gray-600 dark:text-gray-300">
                        {t("accounting.budget_tracker.progress", "Progress")}
                    </span>
                    <span
                        className={`font-medium ${
                            (progress?.usage_percentage || 0) > 80
                                ? "text-red-600"
                                : "text-darkBrown"
                        }`}
                    >
                ...
                <div className="w-full bg-beige rounded-full h-2">
                    <div
                        className={`h-2 rounded-full transition-all ${
                            (progress?.usage_percentage || 0) > 80
                                ? "bg-red-500"
                                : (progress?.usage_percentage || 0) > 50
                                  ? "bg-yellow-500"
                                  : "bg-green-500"
                        }`}
                        style={{
                            width: `${Math.min(progress?.usage_percentage || 0, 100)}%`,
                        }}
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                    <p className="text-walnut/80">
                        {t("accounting.budget_tracker.budget", "Budget")}
                    </p>
                ...
                <div>
                    <p className="text-walnut/80">
                        {t("accounting.budget_tracker.spent", "Spent")}
                    </p>
                    <p className="font-medium text-darkBrown">
                ...
                <div>
                    <p className="text-walnut/80">
                        {t("accounting.budget_tracker.remaining", "Remaining")}
                    </p>
                    <p
                        className={`font-medium ${
                            (progress?.remaining_amount || 0) < 0
                                ? "text-red-600"
                                : "text-green-600"
                        }`}
                    >
