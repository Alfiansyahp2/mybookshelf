                            ...
                            <div className="relative z-10">
                                ...
                                <div className="p-6 space-y-4 flex-1">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            <div className="text-walnut/60 text-xs uppercase tracking-wide mb-1">
                                                Author
                                            </div>
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <div className="font-medium text-darkBrown font-mono text-xs">
                                    ...
                                    <div className="pt-4 border-t border-walnut/10">
                                        <div className="text-xs text-walnut/60 uppercase tracking-wide mb-3">
                                            Your Rating
                                        </div>
                                    ...
                                    <div className="pt-4 border-t border-walnut/10">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="text-xs text-walnut/60 uppercase tracking-wide">
                                                Your Notes
                                            </div>
                                            {!isEditingNotes ? (
                                                <button
                                        ...
                                        {!isEditingNotes ? (
                                            <div className="p-3 bg-cream/30 rounded-xl border border-walnut/20 min-h-[80px] max-h-[200px] overflow-y-auto">
                                                <p className="text-sm text-walnut/80 whitespace-pre-wrap">
                                                    {userNotes ||
                            ...
                            <div className="p-8 h-full flex flex-col relative z-10">
                                ...
                                {isReading && (
                                    ...
                                    >
                                        ...
                                        {/* Reading Session */}
                                        <div className="bg-white rounded-2xl p-6 mb-6 border border-walnut/10 shadow-sm">
                                            <div className="text-xs text-walnut/60 uppercase tracking-wide mb-4">
                                                Current Session
                                            </div>
                                        ...
                                        <div className="bg-white rounded-2xl p-6 mb-6 border border-walnut/10 shadow-sm">
                                            ...
                                            <div className="mt-4 pt-4 border-t border-walnut/10">
                                                <label className="text-xs text-walnut/60 block mb-2">
                                                    Update Progress
                                                </label>
                                                <input
                                                    type="range"
                                        ...
                                        {/* Action Button */}
                                        <button
                                            className="w-full py-4 bg-walnut text-white rounded-xl hover:bg-darkBrown transition-all hover:scale-105 flex items-center justify-center mt-auto"
                                ...
                                {isFinished && (
                                    ...
                                    >
                                        <div className="flex items-center gap-4 mb-6">
                                            ...
                                            <div>
                                                <div className="font-semibold text-xl text-darkBrown">
                                                    Finished
                                                </div>
                                                <div className="text-sm text-walnut/60">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="bg-cream rounded-xl p-4">
                                                <div className="text-xs text-walnut/60 uppercase tracking-wide mb-2">
                                                    Total Reading Time
                                                </div>
                                ...
                                <>
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-6">
                                            <h3 className="text-xl font-semibold text-darkBrown">
                                                Borrow Book
                                            </h3>
                                            <button
                                                onClick={() =>
