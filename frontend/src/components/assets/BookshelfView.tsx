            ...
            <div className="relative" style={{ perspective: "1000px" }}>
                ...
                ${shadeColor(shelfColor, -10)} 4px
                    ...
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2">
                        ...
                        >
                            <span
                                className="text-white text-sm font-serif font-semibold"
                                style={{
                ...
                >
                    {books.map((book, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Quick Info Tooltip */}
                                {isHovered && (
                                    <div className="absolute left-full ml-4 top-0 bg-white rounded-lg shadow-xl p-3 z-10 pointer-events-none min-w-[180px]">
                                        <div className="font-serif font-bold text-darkBrown text-sm line-clamp-1 mb-1">
                                            {book.title}
                                        </div>
                                        <div className="text-xs text-walnut/70 mb-2">
                                            {book.author}
                                        </div>
                    ...
                    {books.length < 10 &&
                        Array.from({
                            length: Math.min(5, 10 - books.length),
                        }).map((_, index) => (
                            <div
                                key={`empty-${index}`}
