        ...
        >
                    ...
                    <div className="relative flex-shrink-0">
                        ...
                        >
                            ...
                            <div className="relative h-full p-6 flex flex-col justify-between">
                                <div>
                                    <h3
                                        className="text-white font-serif font-bold text-2xl mb-2"
                                        style={{
                                            textShadow:
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    {book.publisher && (
                        <div>
                            <div className="text-xs text-walnut/60 mb-1">
                                Publisher
                            </div>
                ...
                {book.personalNotes && (
                    <div>
                        <div className="text-xs text-walnut/60 mb-2">
                            Personal Notes
                        </div>
