                ...
                return (
                    ...
                    >
                            ...
                            >
                                ...
                                <div className="relative h-full p-4 flex flex-col justify-between">
                                    ...
                                    <div className="space-y-2">
                                        <h3
                                            className="text-white font-serif font-bold leading-tight line-clamp-3"
                                            style={{
                                                textShadow:
                                        ...
                                        <p
                                            className="text-white/90 text-sm line-clamp-1"
                                            style={{
                                                textShadow:
                        ...
                        <div className="mt-3 text-center">
                            <h4 className="font-semibold text-darkBrown text-sm line-clamp-1">
                                {book.title}
                            </h4>
                            <p className="text-xs text-walnut/70 line-clamp-1">
                                {book.author}
                            </p>
                        </div>
