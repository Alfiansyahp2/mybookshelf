                                            ...
                                            {currentPage === 0 && (
                                                ...
                                                >
                                                    ...
                                                    <div className="border-b-2 border-walnut/20 pb-4">
                                                        ...
                                                        <p className="text-xl text-walnut/80">
                                                            {book.author}
                                                        </p>
                                                    </div>
                                                        ...
                                                        {book.genre && (
                                                            <div className="flex items-center gap-3 p-3 bg-walnut/10 rounded-lg">
                                                                <div className="w-8 h-8 bg-walnut/20 rounded-full flex items-center justify-center">
                                                                    <span className="text-xs font-bold text-walnut">
                                                                        {
                                                                            book
                                                                                .genre[0]
                                                                        }
                                                                ...
                                                                <div>
                                                                    <div className="text-lg font-bold text-darkBrown truncate">
                                                                        {
                                                                            book.genre
                                                                        }
                                                                    </div>
                                                    ...
                                                    {onRate && (
                                                        <div>
                                                            <div className="text-sm text-walnut/70 mb-2">
                                                                Rate this book:
                                                            </div>
                                                    ...
                                                    <div className="flex gap-3">
                                                        ...
                                                        >
                                                            <Heart
                                                                className={`w-5 h-5 ${book.favorite ? "fill-white" : ""}`}
                                                            />
                                                            {book.favorite
                                                                ? "Favorited"
                                                                : "Favorite"}
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            {book.isbn && (
                                                                <div className="flex justify-between p-3 bg-walnut/10 rounded-lg">
                                                                    ...
                                                                    <span className="font-medium text-darkBrown font-mono text-sm">
                                                                        {
                                                                            book.isbn
                                                                        }
                                                                    </span>
                                        ...
                                        <div className="h-full p-8 overflow-y-auto">
                                            ...
                                            {currentPage === 0 && (
                                                ...
                                                >
                                                    ...
                                                    {/* Reading Timeline */}
                                                    <div>
                                                        <h3 className="text-lg font-serif font-bold text-darkBrown mb-3">
                                                            Timeline
                                                        </h3>
                                            ...
                                            {currentPage === 1 && (
                                                ...
                                                >
                                                    ...
                                                    {/* Physical Attributes */}
                                                    <div>
                                                        <h4 className="text-lg font-semibold text-darkBrown mb-3">
                                                            Physical Attributes
                                                        </h4>
                                                        <div className="grid grid-cols-2 gap-3">
                                                            <div className="p-3 bg-walnut/10 rounded-lg">
                                                                ...
                                                                <div className="text-sm font-medium text-darkBrown capitalize">
                                                                    {
                                                                        book.height
                                                                    }
                                                                </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-center py-4">
                                                            <div className="text-walnut/60 text-sm">
                                                                No collections
                                                                yet
                                                            </div>
