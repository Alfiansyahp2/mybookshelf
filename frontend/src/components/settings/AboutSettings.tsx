            ...
            <div className="bg-white rounded-2xl p-6 border border-walnut/10 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            <div>
                                <p className="font-medium text-darkBrown group-hover:text-walnut transition-colors">
                                    {t("settings.about.website", "Website")}
                                </p>
                                <p className="text-sm text-walnut/70">
                                    {t(
                                        "settings.about.website_desc",
                        ...
                        >
                            <div>
                                <p className="font-medium text-darkBrown group-hover:text-walnut transition-colors">
                                    {t("settings.about.github", "GitHub")}
                                </p>
                                <p className="text-sm text-walnut/70">
                                    {t(
                                        "settings.about.github_desc",
                                        "View source code",
                                    )}
                                </p>
                            </div>
