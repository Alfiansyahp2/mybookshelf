...
export default function DecorationPicker({
    ...
    return (
        <Modal
            ...
            title={
                slot === "left"
                    ? t("shelf_decoration.title_left", "Hiasan Rak (Sisi Kiri)")
                    : t(
                          "shelf_decoration.title_right",
                          "Hiasan Rak (Sisi Kanan)",
                      )
            }
            size="md"
        >
            <div className="flex flex-col h-full max-h-[60vh]">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    {current && (
                        ...
                        >
                            <Trash2 size={14} />{" "}
                            {t("shelf_decoration.remove", "Hapus Hiasan")}
                        </button>
                    )}
                </div>
                ...
                <div className="mb-6 p-6 bg-walnut/5 border border-walnut/10 rounded-xl flex items-end justify-center min-h-[100px]">
                    {preview ? (
                        ...
                        <p className="text-sm text-walnut/40">
                            Arahkan kursor untuk melihat pratinjau
                        </p>
                    )}
                </div>
                ...
                `}
                            ...
                            >
                                ...
                                <span className="text-[11px] font-bold text-darkBrown leading-tight">
                                    {t(
                                        `shelf_decoration.${item.kind}`,
                                        item.label,
                                    )}
                                </span>
                                <span className="text-[9px] text-walnut/70 leading-tight">
                                    {t(
                                        `shelf_decoration.${item.kind}_desc`,
                                        item.desc,
                                    )}
                                </span>
