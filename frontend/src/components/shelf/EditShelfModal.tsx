                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-walnut/60 mt-1">
                                                    {t(
                                                        "modals.editShelf.capacity_hint",
