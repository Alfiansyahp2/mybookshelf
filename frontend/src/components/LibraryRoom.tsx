        ...
        >
            ...
            <div
                style={{
                    ...
                    height: 200,
                    background:
                        "radial-gradient(ellipse at 50% 30%, rgba(255,210,100,0.22) 0%, rgba(255,180,60,0.06) 55%, transparent 100%)",
                    pointerEvents: "none",
                }}
            />
            ...
            <div
                style={{
                    ...
                    borderRadius: 3,
                    background:
                        "linear-gradient(to right,#8b6030,#c49060,#8b6030)",
            ...
            <div
                style={{
                    ...
                    borderRadius: "50%",
                    background:
                        "radial-gradient(circle at 40% 35%,#d4a060,#7a4820)",
            ...
            <div
                style={{
                    ...
                    height: 36,
                    background:
                        "linear-gradient(180deg,#d4954a 0%,#b87030 60%,#8b5020 100%)",
            ...
            <div
                style={{
                    ...
                    height: 24,
                    background:
                        "linear-gradient(180deg,rgba(255,220,120,0.6),rgba(255,180,60,0.2))",
            ...
            <div
                style={{
                    ...
                    height: 80,
                    background:
                        "linear-gradient(180deg,rgba(255,210,100,0.18) 0%,transparent 100%)",
        ...
        >
            ...
            <div
                style={{
                    ...
                    height: 36,
                    background:
                        "linear-gradient(180deg,#c4784a 0%,#a05830 50%,#7a3e18 100%)",
            ...
            <div
                style={{
                    ...
                    borderRadius: 2,
                    background:
                        "linear-gradient(to right,#2d6a2a,#4a9a44,#2d6a2a)",
                }}
            />
    ...
    return (
        <div
            style={{
                ...
                boxShadow:
                    "2px 4px 12px rgba(0,0,0,0.45), inset 0 0 0 2px rgba(255,255,255,0.08)",
                position: "relative",
                overflow: "hidden",
                ...style,
            }}
        ...
        <div style={{ position: "relative", width: 14, height: 50 }}>
            ...
            <motion.div
                style={{
                    ...
                    height: 42,
                    background:
                        "radial-gradient(circle,rgba(255,200,60,0.35) 0%,transparent 75%)",
                    pointerEvents: "none",
                }}
                animate={{
                    opacity: [0.8, 1, 0.7, 1],
            ...
            <div
                style={{
                    ...
                    height: 42,
                    background:
                        "linear-gradient(to right,#e8dcc8,#f5efe0,#e0d4b8)",
          ...
          black 22px, black 26px)`,
            ...
            <div
                style={{
                    ...
                    pointerEvents: "none",
                    background:
                        "linear-gradient(180deg,rgba(180,100,40,0.45) 0%,rgba(120,60,20,0.35) 100%)",
                }}
            />
            ...
            >
                ...
                >
                    ...
                    <div
                        style={{
                            background:
                                "linear-gradient(135deg,rgba(60,35,12,0.85),rgba(40,22,6,0.9))",
