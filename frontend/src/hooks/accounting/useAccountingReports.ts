...
export function useAccountingOverview(params?: {
    start_date?: string;
    end_date?: string;
...
export function useExpensesByCategoryReport(params?: {
    start_date?: string;
    end_date?: string;
    category_id?: string;
}) {
...
export function useExpensesByPeriodReport(params: {
    start_date: string;
    end_date: string;
...
// Get budget tracking
export function useBudgetTrackingReport(params?: {
    is_active?: boolean;
    period?: string;
}) {
    return useQuery({
...
export function usePaymentMethodsAnalysis(params?: {
    start_date?: string;
    end_date?: string;
}) {
    return useQuery({
