...
export function useAchievementTracker() {
    ...
    useEffect(() => {
        ...
        const pagesRead = finishedBooks.reduce(
            (sum, b) => sum + (b.pages || b.totalPages || 0),
            0,
        );
        const genres = new Set(
            books.filter((b) => b.genre).map((b) => b.genre),
        );
        ...
        checkAchievement(
            "first-book",
            "Langkah Pertama",
            "Kamu telah menambahkan buku pertama ke perpustakaanmu!",
            totalBooks >= 1,
        );
        ...
        checkAchievement(
            "kutu-buku-1",
            "Kutu Buku Pemula",
            "Berhasil menyelesaikan 5 buku.",
            finishedBooks.length >= 5,
        );
        checkAchievement(
            "kutu-buku-2",
            "Kutu Buku Pro",
            "Berhasil menyelesaikan 20 buku!",
            finishedBooks.length >= 20,
        );
        ...
        checkAchievement(
            "kolektor",
            "Kolektor",
            "Perpustakaanmu kini memiliki 20 buku.",
            totalBooks >= 20,
        );
        checkAchievement(
            "kolektor-master",
            "Master Kolektor",
            "Luar biasa, kamu memiliki 50 buku!",
            totalBooks >= 50,
        );
        ...
        checkAchievement(
            "ahli-genre",
            "Eksplorator Genre",
            "Membaca buku dari 3 genre yang berbeda.",
            genres.size >= 3,
        );
        checkAchievement(
            "master-genre",
            "Master Genre",
            "Membaca buku dari 7 genre yang berbeda.",
            genres.size >= 7,
        );
        ...
        checkAchievement(
            "arsitek-rak",
            "Arsitek Rak",
            "Membuat 3 rak berbeda untuk koleksimu.",
            shelves.length >= 3,
        );
        ...
        checkAchievement(
            "kurator",
            "Kurator Sempurna",
            "Memberikan rating bintang 5 pada sebuah buku.",
            fiveStarBooks.length >= 1,
        );
        ...
        checkAchievement(
            "marathon",
            "Marathon Membaca",
            "Telah membaca lebih dari 1.000 halaman.",
            pagesRead >= 1000,
        );
        checkAchievement(
            "marathon-ultra",
            "Ultra Marathon",
            "Telah membaca lebih dari 5.000 halaman!",
            pagesRead >= 5000,
        );
        ...
        checkAchievement(
            "penggemar",
            "Penggemar Setia",
            "Menandai 5 buku sebagai favorit.",
        ...
        checkAchievement(
            "pemimpi",
            "Sang Pemimpi",
            "Menambahkan 5 buku ke Wishlist.",
