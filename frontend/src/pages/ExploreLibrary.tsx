...
export default function ExploreLibrary() {
    ...
    if (shelves.length === 0) {
        return (
            <div className="p-8 text-center text-walnut/60">
                {t(
                    "explore.no_shelves",
                    "Tidak ada rak. Silakan tambahkan rak di perpustakaan.",
                )}
            </div>
        );
    }
        ...
        <div className="p-8">
            ...
            <div className="mb-8">
                <h1 className="text-3xl font-serif text-darkBrown mb-2">
                    {t("explore.title", "Explore Library")}
                </h1>
            ...
            <div className="bg-white rounded-2xl p-6 mb-8 border border-walnut/10 shadow-sm">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-serif text-darkBrown mb-1">
                            {t("explore.main_room", "Main Library Room")}
                        </h2>
            ...
            <div className="mt-8 bg-walnut/5 rounded-xl p-4 text-center text-sm text-walnut/60">
                <p>
                    ...
                    {t(
                        "explore.tip",
                        'Tip: Use <kbd className="px-2 py-1 bg-white rounded">←</kbd> and <kbd className="px-2 py-1 bg-white rounded">→</kbd> arrow keys to navigate between shelves',
